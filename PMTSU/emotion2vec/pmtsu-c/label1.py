                    ...
                    if process_block and line.startswith('['):
                        ...
                        if emotion in valid_emotions:
                            try:
                                ...
                                v_raw, a_raw, d_raw = map(float, vad_str.split(','))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--output', default='/mnt/cxh10/database/lizr/emotion/emotion2vec/iemocap_downstream_main2/vad.lab', help='Output label file path')
