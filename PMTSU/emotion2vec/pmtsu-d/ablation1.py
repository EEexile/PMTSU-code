        ...
        for epoch in range(cfg.optimization.epoch):
            ...
            if epoch < phase1_epochs:
               ...
               # 阶段2: 渐进式解冻参数
                ...
                task_weights = [0.60, 0.4/3, 0.4/3, 0.4/3]   
                
                logger.info(f"Epoch {epoch+1}: PHASE 2 - Task Weights: Emo={task_weights[0]:.2f}, VAD Total={sum(task_weights[1:]):.2f} (V={task_weights[1]:.2f}, A={task_weights[2]:.2f}, D={task_weights[3]:.2f})")
