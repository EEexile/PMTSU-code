...
def get_parser():
    ...
    parser.add_argument('--split', help='which split to read (e.g., train, test)', default='train')
    parser.add_argument('--checkpoint', type=str, help='path to HuBERT checkpoint (e.g., hubert_large_ll60k.pt)', default='/mnt/cxh10/database/lizr/emotion/hubert_large/model/hubert_large_ll60k.pt')
    parser.add_argument('--save-dir', help='where to save the output .npy and .lengths', default='/mnt/cxh10/database/lizr/emotion/hubert_large/iemocap_downstream/feats')
